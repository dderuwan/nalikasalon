...
Route::group(['middleware'=>['role:Super Admin|Admin']],function(){
    ...
    // supplier module
     Route::get('/allsupplier', [App\Http\Controllers\SupplierController::class, 'index'])
        ->name('allsupplier')
        ->middleware(['role:Super Admin', 'permission:View Supplier']);

     Route::get('/createsupplier',[App\Http\Controllers\SupplierController::class,'create'])->name('createsupplier')
        ->middleware(['role:Super Admin', 'permission:Create Supplier']);
...
Route::get('/addpackages', [App\Http\Controllers\PackageController::class, 'create'])->name('addpackages')->middleware(PermissionMiddleware::using('create packages'));
...
Route::group(['middleware'=>['role:Main Dresser']],function(){
        //reports
        Route::get('/orderreport', [App\Http\Controllers\reportController::class, 'orderreport'])->name('orderreport');
        Route::get('/productreport', [App\Http\Controllers\reportController::class, 'productreport'])->name('productreport');
        Route::get('/customerreport', [App\Http\Controllers\reportController::class, 'customerreport'])->name('customerreport');
