    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row mb-2">
                ...
                <div class="col-md-6">
                    <a href="{{ route('RealcreateSalonThretment') }}" class="btn btn-primary mb-3">Add Booking</a>
                </div>
            </div>
            <p class="card-text"></p>
            <div class="row my-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                    <!-- Edit Button -->
                                                    <a href="{{ route('RealeditSalonThretment', $service->id) }}" class="btn btn-primary"><i class="fe fe-edit fe-16"></i></a>
                                            @endif

                                            <!-- Delete Button -->
                                            <button class="btn btn-danger" onclick="confirmDelete({{ $service->id }})"><i class="fe fe-trash fe-16"></i></button>
                                            <form id="delete-form-{{ $service->id }}" action="{{ route('RealdeleteSalonThretment', $service->id) }}" method="POST" style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
