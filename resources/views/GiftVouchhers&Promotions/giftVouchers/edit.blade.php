...
<main role="main" class="main-content">
    <div class="container">
        ...
        <form action="{{ route('updateGiftVoucher', $giftVoucher->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            
            <div class="form-group">
                <label for="gift_voucher_Id">Name </label>
                <input type="text" id='gift_voucher_Id' name="gift_voucher_Id" class="form-control" value="{{ $giftVoucher->gift_voucher_Id }}" readonly>
            </div>
            <div class="form-group">
                <label for="gift_voucher_name">Name </label>
                <input type="text" id='gift_voucher_name' name="gift_voucher_name" class="form-control" value="{{ $giftVoucher->gift_voucher_name }}" required>
            </div>
            <div class="form-group">
